...
from app.schemas import DailyStatisticsOut, PatientMetricsOut, TimelineOut
...
class DailyStatisticsIntegrationTests(unittest.TestCase):
    ...
    def test_patient_timeline_serializes_statistics_and_does_not_accept_another_patient(self):
        ...
        result = TimelineOut.model_validate(response.json()).model_dump()
