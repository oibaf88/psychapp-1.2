                  ...
                  <tbody>
                    {(
                      [
                        ...
                        ["9", "N3_unstable_persistente_con_convergencia", 3, "Banda de deterioro unstable ≥ 3 días distintos con sueño descendente o rumiación elevada"],
                        ["10", "N3_unstable_persistente", 3, "Banda de deterioro unstable ≥ 5 días distintos"],
                        ["11", "N3_desestabilizacion_psicosocial_aguda", 3, "Cambio adverso en 14 días y otra señal convergente"],
                        ["12", "N3_riesgo_interpersonal_alto", 3, "Carga percibida y pertenencia frustrada elevadas, expresadas en 14 días"],
                        ["13", "N3_riesgo_recaida_contextual", 3, "Contexto de consumo elevado y craving ascendente"],
                        ["14", "N3_convergencia_psicosocial_estructural", 3, "Índice psicosocial ≥ 0.60 y banda de deterioro unstable"],
                        ["15", "N2_desviacion_moderada", 2, "Banda de deterioro transition o primer día unstable, sin criterios superiores"],
                        ["16", "N2_vulnerabilidad_psicosocial", 2, "Apoyo bajo, adversidad material, cambio adverso o índice psicosocial ≥ 0.50"],
                        ["17", "N0_estable", 0, "Sin deterioro estadístico suficiente ni criterios superiores; no equivale a seguridad clínica"],
                        ["18", "N1_datos_insuficientes_o_sin_criterios", 1, "Datos insuficientes para calcular deterioro"],
                        ["19", "N1_sin_criterios_superiores", 1, "Regla de cierre"],
                      ] as const
